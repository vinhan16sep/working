                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-sm-9 col-md-9 col-sx-12">
                            ...
                            echo form_input('income', set_value('income', $product['income']), 'class="form-control"');
                            ?>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    $('.btn-checkbox-group-1').each(function(){
        if($('.btn-checkbox-group-1').prop("checked") == true){
    ...
    $('.btn-checkbox-group-4').each(function(){
        if($('.btn-checkbox-group-4').prop("checked") == true){
